...
// // Header Component
// const DashboardHeader = ({ clubInfo, activeTab, setActiveTab, handleLogout }) => {
//   return (
...
//             <span className="club-name">{clubInfo?.name || "N/A"}</span>
//             {clubInfo?.logo_url && (
...
// // Club Profile Component
// const ClubProfileManagement = ({ clubInfo, editingClub, setEditingClub, handleUpdateClub }) => {
//   return (
//     <div className="management-section">
//       <h2>Club Profile</h2>
...
//         </div>
//         <div className="form-actions">
//           <button onClick={handleUpdateClub} className="primary-btn">
//             Update Club Details
//           </button>
//         </div>
//       </div>

//       <div className="current-club-info">
//         <h3>Current Club Information</h3>
//         <div className="club-info-card">
//           <div className="club-header">
//             {clubInfo.logo_url && (
//               <img src={clubInfo.logo_url} alt={clubInfo.name} className="club-logo-large" />
//             )}
//             <div>
//               <h4>{clubInfo.name}</h4>
//               <p>Admin ID: {clubInfo.admin_user_id}</p>
//             </div>
//           </div>
//           <p className="club-description">{clubInfo.description}</p>
//           <p className="created-date">Created at: {format(new Date(clubInfo.created_at), "PPpp")}</p>
//         </div>
//       </div>
//     </div>
//   );
...
//             <p>⚠️ No club found for this admin user.</p>
//           </div>
//         ) : (
//           <>
//             {activeTab === "events" && (
